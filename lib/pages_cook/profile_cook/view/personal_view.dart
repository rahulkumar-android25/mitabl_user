      ...
      children: [
        ...
        Column(
          ...
          children: [
            ...
            Text(
              'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas vel eros vel diam faucibus imperdiet',
              style: GoogleFonts.gothicA1(
                  color: Theme.of(context).primaryColorDark,
                    ...
                    children: [
                      Stack(
                        children: [
                          ...
                          Align(
                            alignment: Alignment.center,
                            widthFactor: config.AppConfig(context).appWidth(0.38),
